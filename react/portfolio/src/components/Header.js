        ...
        >
          ...
          <nav>
            <HStack spacing={8}>
              ...
              <a href='/#projects' onClick={() => handleClick('projects')} style={{ fontWeight: 'bold' }}>Projects</a>
              <a href='/#contact-me' onClick={() => handleClick('contactme')} style={{ fontWeight: 'bold' }}>Contact Me</a>
            </HStack>
          </nav>
        </HStack>
      </Box>
